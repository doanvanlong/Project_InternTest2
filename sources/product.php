...
if ($id != '') {
	...
	$id_sp=$row_detail['id'];
	$d->reset();
	$sql = "select *,ten$lang as ten from table_product where id_danhmuc=$id_danhmuc and id!= $id_sp and hienthi=1 and type='san-pham' and noibat=1 order by id desc limit 0,12";
	$d->query($sql);
...
$d->reset();
$sql = "select *,ten$lang as ten from table_product where $where limit 0,12";
$d->query($sql);
