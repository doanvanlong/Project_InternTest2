...
<h1 style="position:absolute; top:-1000px;"><?php if($title!='')echo $title;else echo $company['title'];?></h1>
    ...
    <?php if($_GET['com'] == 'index' || $_GET['com'] == ''){?>
		...
		<?php include _template."layout/dichvuindex.php";?>
		<?php include _template.$template."_tpl.php"; ?>
		<?php include _template."layout/visaochontoi.php";?>
		<?php include _template."layout/ykienkhach.php";?>
		<?php include _template."layout/lienheindex.php";?>
		<?php include _template."layout/news_index.php";?>

	<?php  }elseif($_GET['com'] == 'san-pham'  ||   !isset($_GET['id']) ){ ?>
