<div class="wrapper">
  ...
  <div class="userNav">
    <ul>
      ...
      $row_baogia = demContact('bao-gia');
      $row_datxe = demContact('yeu-cau-dat-xe');



      $tong_count =  $row_danhgia['num'] + $row_goidien + $row_guitin + $row_lienhe + $row_baogia +$row_datxe;
      ...
      <li class="ddnew"><a title=""><img src="images/icons/topnav/messages.png" alt="" /><span>Thông báo</span><span class="numberTop"><?= $tong_count ?></span></a>
        <ul class="userMessage">
          ...
          <li><a href="index.php?com=contact&act=man&type=bao-gia" title=""><span><i class="fa fa-envelope"></i>&nbsp;Báo giá</span><span class="numberTop"><?= $row_baogia ?></span></a></li>
          <li><a href="index.php?com=contact&act=man&type=yeu-cau-dat-xe" title=""><span><i class="fa fa-envelope"></i>&nbsp;Đặt xe</span><span class="numberTop"><?= $row_datxe ?></span></a></li>
