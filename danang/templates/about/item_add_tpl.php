		...
		<?php foreach ($config['lang'] as $key => $value) { ?>
			<div id="content_lang_<?= $key ?>" class="tab_content ">
				<div class="myrow">
					...
					<div class="<?php if ($key == "") {
									if ($config_s['hinhanh']) {
										echo "mycol-6 mycol-table-6";
									} else {
										echo "mycol-12 mycol-table-8";
									}
								} else {
									echo "mycol-12 mycol-table-8";
								} ?> mycol-mobi-12">
						...
						<div class="mycol-6 mycol-table-6 mycol-mobi-12">
							<div class="formRow <?= (!$config_s['hinhanh']) ? 'none' : '' ?>">
								<div class="photoUpload-zone">
									...
									<div class="mycol-6 mycol-table mycol-mobi-12 d-flex">
										<div class="formRow">
											...
											<div class="photoUpload-detail" id="photoUpload-preview">
												<img class="rounded" src="<?= _upload_hinhanh . $item['photo'] ?>" onerror="src='images/noimage.png'" alt="Alt Photo" />
												<div class="none">Hình hiện tại</div>
												<?php
										...
										<?php
										if ($type == 'text-gioi-thieu') {
										?>
											<div class="formRow">
												<label class="photoUpload-file" id="photo-zone2" for="file-zone2" style="border: none; background:none;padding: 0px; display: inherit;">
													<input type="file" name="file2" id="file-zone2">
													<!--<i class="fa fa-cloud-upload"></i>
												<p class="photoUpload-drop">Kéo và thả hình vào đây</p>
												<p class="photoUpload-or">hoặc</p>-->
													<div class="photoUpload-choose2 btn btn-info">+ Tải ảnh đại diện lên</div>
												</label>
												<div class="photoUpload-detail" id="photoUpload-preview2">
													<img class="rounded" src="<?= _upload_hinhanh . $item['photo2'] ?>" onerror="src='images/noimage.png'" alt="Alt Photo" />
													<div class="none">Hình hiện tại</div>
													<?php

													$file_size = filesize($_SERVER['DOCUMENT_ROOT'] . "/" . _upload_hinhanh_l . $item['photo2']); // Get file size in bytes
													$file_size = $file_size / 1000; // Get file size in KB
													?>
													<div class="detailImages">
														...
														<div class="btn">
															<div class="removeInput" data-id="<?= $item["id"] ?>" data-photo="<?= $item["photo2"] ?>" data-format="<?= _upload_hinhanh ?>" data-table="about" data-field="photo">
																<a class="icon-jfi-trash jFiler-item-trash-action"></a>
															</div>
														</div>
