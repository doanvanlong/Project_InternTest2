       ...
       <div id="info" class="tab_content">
        <div class="myrow">
			<div class="mycol-5 mycol-table-6 mycol-mobi-12">
				...
				<div class="formRow <?= (!$config_s['hieuxe'])?'none':'' ?>">
					<label>Hiệu xe: </label>
					<div class="formRight">
						<input type="text" id="hieuxe" name="hieuxe" value="<?=@$item['hieuxe']?>"  title="Nhập hiệu xe" class="tipS "  />
					</div>
					<div class="clear"></div>
				</div> 
				<div class="formRow <?= (!$config_s['doixe'])?'none':'' ?>">
					<label>Đời xe: </label>
					<div class="formRight">
						<input type="text" id="doixe" name="doixe" value="<?=@$item['doixe']?>"  title="Nhập đời xe" class="tipS "  />
					</div>
					<div class="clear"></div>
				</div> 
				<div class="formRow <?= (!$config_s['kieuxe'])?'none':'' ?>">
					<label>Kiểu xe: </label>
					<div class="formRight">
						<input type="text" id="kieuxe" name="kieuxe" value="<?=@$item['kieuxe']?>"  title="Nhập kiểu xe : chỗ" class="tipS conso"  onkeypress="return OnlyNumber(event)"  />
					</div>
					<div class="clear"></div>
				</div> 
				<div class="formRow <?= (!$config_s['mauxe'])?'none':'' ?>">
					<label>Màu xe: </label>
					<div class="formRight">
						<input type="text" id="mauxe" name="mauxe" value="<?=@$item['mauxe']?>"  title="Nhập màu xe" class="tipS "    />
					</div>
					<div class="clear"></div>
				</div> 
				<div class="formRow <?= (!$config_s['loaixe'])?'none':'' ?>">
					<label>Loại xe: </label>
					<div class="formRight">
						<input type="text" id="loaixe" name="loaixe" value="<?=@$item['loaixe']?>"  title="Nhập kiểu xe " class="tipS "    />
					</div>
					<div class="clear"></div>
				</div> 
				<div class="formRow none">
