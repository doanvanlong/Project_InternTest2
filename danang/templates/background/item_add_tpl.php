...
<form name="supplier" id="validate" class="form" action="index.php?com=background&act=save<?php if ($_REQUEST['type'] != '') echo '&type=' . $_REQUEST['type']; ?>" method="post" enctype="multipart/form-data">
  ...
  <div class="widget mt-10">
            ...
            <div class="formRow">
              ...
              <div class="formRight">
                <div class="photoUpload-zone">
                  ...
                  <div class="photoUpload-detail" id="photoUpload-preview"><img class="rounded" src="<?= _upload_hinhanh . $item['photo'] ?>" onerror="src='images/noimage.png'" alt="Alt Photo" />
    ...
    <div class="formRow <?= (!$config_s['ten']) ? 'none' : '' ?>">
      <label>Tiêu đề: </label>
      <div class="formRight">
        <input type="text" id="tieude" name="title" value="<?= @$item['title'] ?>" title="Nhập tiêu đề " class="tipS" />
      </div>
      <div class="clear"></div>
    </div>
